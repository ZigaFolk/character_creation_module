...
def attack(char_name: str, char_class: str) -> str:
    """Возвращает урон в зависимости от класса персонажа."""
...
def defence(char_name: str, char_class: str) -> str:
    """Возвращает защиту в зависимости от класса персонажа."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Функция предлагает потренироваться."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Возвращает присваивание класса персонажа."""
    approve_choice: str = ''
    char_class: str = ''
